...
public class Main {
	...
	public static void main(String[] args) {
		...
		ProductoOtaku producto = dao.obtenerProductoPorId(12);
		if (producto != null) {
        ...
        // Eliminar producto
        boolean eliminado = dao.eliminarProducto(10); // Asegúrate de usar un ID válido
